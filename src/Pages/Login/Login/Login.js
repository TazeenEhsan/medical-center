...
const Login = () => {
    ...
    return (
        <div className="mx-5 mb-3 container mx-auto w-50">
            ...
            <button className="btn btn-danger mb-5" onClick={handleBtnEmail}><i className="fas fa-sign-in-alt"></i>  Login Using Email</button> <br />
            <Link to='/register'><button className="btn btn-danger mb-5"><i className="fas fa-user-plus"></i> Sign Up</button></Link>
            ...
            {logViaEmail &&
                <form onSubmit={handleLogin}>
                    ...
                    <button type="submit" className="btn btn-primary" style={{ backgroundColor: 'green', color: 'white', padding: '10px', borderRadius: '5px' }}>
                        Login
                    </button>
